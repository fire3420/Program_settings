...
function doc_keyUp(e) {
    if (e.ctrlKey && e.altKey && e.keyCode == 79) { //^!o = !+d
        ...
        var button30 = $("span").filter(function () { return ($(this).text() === '하위 할 일 추가') });
        ...
        var button8 = $('div[role="button"]:contains("할 일 추가")')[0];
        button8.click();
        //alert('success');
        ...
        var button10 = $("span").filter(function () { return ($(this).text() === '확인') });
        if (button10) {
